...
public class Target {
	...
	public void setIdTarget(String idTargert) {
		this.idTarget = idTargert;
	}
	...
	public String toString() {
		return "Target{" + "idTarget='" + idTarget + '\'' + ", nameTarget='" + nameTarget + '\'' + ", valueTicket="
				+ valueTicket + '\'' + "distance='" + distance + '}';
	}
